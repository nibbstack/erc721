...
import "./nf-token.sol";
import "../interface/erc721-enumerable.sol";
...
contract NFTokenEnumerable is NFToken, ERC721Enumerable {
  /**
    * @dev List of revert message codes. Implementing dApp should handle
  ...
  /**
    * @notice Use and override this function with caution. Wrong usage can
  ...
  /**
    * @notice Use and override this function with caution. Wrong usage can have
