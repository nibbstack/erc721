...
contract('NFTokenMetadataEnumerableMock', (accounts) => {
  ...
  it('corectly transfers NFT from owner', async () => {
    ...
    await nftoken.mint(sender, id2, 'url');
  ...
  it('corectly transfers NFT from approved address', async () => {
    ...
    await nftoken.mint(owner, id2, 'url');
  ...
  it('returns the correct token by index', async () => {
    ...
    await nftoken.mint(accounts[1], id2, 'url');
    await nftoken.mint(accounts[2], id3, 'url');
